...
- *Directions:* 
  - Simply download the data corresponding to section "Crimes and Clearances (including Arson)"
...
Our interactive figure lets you find out the conditions in which society could save money with
Prop 20's affect on petty theft classification. Below is a general description
...
**You can interact with the live widget [here](https://anitato.shinyapps.io/Societal_Impact_CAProp20/).**
...
### Overview
For these predictions, we first obtain a plausible range of for the number of crimes
